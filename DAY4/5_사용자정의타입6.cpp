...
// set 에 보관하려면 : 크기 비교만 가능하면 됩니다.
// unordered_set    : 1. 사용자 정의 타입에 대한 해쉬 함수 객체
...
//												  std::allocator<People> > s;
	// 그런데,
	// hash<int>, hash<double> 등 은 표준에서 지원하지만
	// hash<People> 은 표준에서 지원 안합니다.
	// 즉, 사용자가 만들어서 전달해야 합니다.
	...
	s.emplace("lee", 25);
	s.emplace("park", 30); // People("park",30) 객체를 해쉬 함수에 전달
