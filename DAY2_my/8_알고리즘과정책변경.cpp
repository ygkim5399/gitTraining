...
#include <algorithm>	// 정렬, 선형검색, 이진 검색등의 알고리즘
#include <numeric>		// 수치 관련 연산 (합, 부분합, 내적 등)
...
int main()
{
	...
	//int n = std::accumulate(v1.begin(), v1.end(), 1, // <- 1 : 초기값, (합은 0, 곱은1) 
